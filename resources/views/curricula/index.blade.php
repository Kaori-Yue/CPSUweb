    ...
    <div class="container">
        ...
        <div class="row col-md-12" style="background: #ffffff">
            <div style="text-align: left">
                <h2 class="bg-success" style="padding: 2%;margin: 1% 1% 0 1%">ระดับปริญญาตรี</h2>
            </div>
        ...
        <div class="row col-md-12" style="background: #ffffff">
            <div style="text-align: left">
                <h2 class="bg-success" style="padding: 2%;margin: 1% 1% 0 1%">ระดับปริญญาโท</h2>
            </div>
        ...
        <div class="row col-md-12" style="background: #ffffff">
            <div style="text-align: left">
                <h2 class="bg-success" style="padding: 2%;margin: 1% 1% 0 1%">ระดับปริญญาเอก</h2>
            </div>
