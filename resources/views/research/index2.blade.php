...
<div class="container">
    ...
    <ul class="wrapper-card-research">
        <li>
            <div class="card-research">
                <img class="image-card-research" src="original.png">
                <div class="detail-card-research">
                    <h1 class="title">ชือเรื่องผลงานวิจัย</h1>
                    <p class="create-by-card-research">โดย : ธนเดช พัดทอง</p>
                </div>
            </div>
        </li>
        <li>
