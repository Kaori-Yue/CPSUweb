<div class="col-md-6 col-sm-6 col-xs-12" style="padding: 0">
    <div class="blog-card">
        <div class="card-title col-md-12" style="background-image: url('{{ url('image/show/'.$blog->cover) }}')">
        ...
        <div class="card-menu col-md-12 col-xs-12">
            ...
            <div class="col-md-2 col-xs-2" style="text-align: right;padding-right: 0;padding-left: 0">
